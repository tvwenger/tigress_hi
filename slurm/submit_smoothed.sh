...
#SBATCH --output="logs/HI_joint_smooth_spectra_logs/%x.%j.%N.out"
#SBATCH --error="logs/HI_joint_smooth_spectra_logs/%x.%j.%N.err"
...
DIR_NAME="HI_joint_smooth_spectra"
PER_JOB=82
NUM_SPEC=81920
...
for (( idx=$START_IDX; idx<$END_IDX; idx++ )); do
    ...
    PYTENSOR_FLAGS="base_compiledir=$tmpdir" python scripts/run_smoothed.py $DIR_NAME $idx
    rm -rf $tmpdir
done
